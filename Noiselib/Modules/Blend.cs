...
{
	/// <summary>
	///      Noise module that outputs a weighted blend of the output values from two source modules given the output value
	...
	public class Blend : Module
	{
		...
		/// </summary>
		/// <param name="noiseModule1">
		///      The first <see cref="Module" /> to connect to this <see cref="Blend" />
		///      <see cref="Module" />.
		/// </param>
		/// <param name="noiseModule2">
		///      The second <see cref="Module" /> to connect to this <see cref="Blend" />
		///      <see cref="Module" />.
		/// </param>
		/// <param name="controlModule">
		///      The control <see cref="Module" /> determines the weight of the blending operation. See
		///      <see cref="ControlModule" /> for further usage.
		/// </param>
		...
		public override double this[double x, double y, double z]
		{
			get
			{
				double v0 = NoiseModule1[x, y, z];
				double v1 = NoiseModule2[x, y, z];
				double alpha = (ControlModule[x, y, z] + 1.0) / 2.0;
